...
These will be held live in person in BIO LT1 from 9:30 to 11:30AM from the 16th to the 20th February unless otherwise announced on Amathuba. 
...
- Monday, 16th Feb - Reproducible Research [@Baker2016; @Peng2011; @Markowetz2015]
- Tuesday, 17th Feb - Data Management [@Michener2012]
- Wednesday, 18th Feb - GitHub, Tidy Data and Data Wrangling [@Wickham2014; @Wickham2019]
- Thursday, 19th Feb - Tidy Data and Data Wrangling continued (your turn) 
- Friday, 20th Feb - We can discuss if you need me available to help. Possibly online.

There will also be an online [UCT Data Management Plan tutorial]( https://uct.ac.za.libcal.com/event/16066564) with Sanjin Muftic (UCT Libraries) on Tuesday the 17th Feb at 1PM. Please sign up for the tutorial. It will be instrumental in helping you complete the first deliverable for this module, which is a draft Data Management Plan (DMP) for your Honours Project (or mock project). 

## Deliverables (Due Thursday the 26th February) {#deliverables}
...
3. Lastly, I'd like you to spend some time reading up about reproducible research and data management (preferably relevant to our field) and to share any interesting resources you find - a link to a paper, news article, blog, tutorial, etc - with a 50 to 200 word summary of what it is and why its relevant and interesting. These need to be different to those already listed in the Further Reading below. You will share your contribution with me (and the world) by using GitHub to clone this repository, adding your content to the Further Reading section and sending me a pull request. You'll see how to do this on Wednesday.


## Software installation and setup (Due Monday 16th Feb) {#setup}
