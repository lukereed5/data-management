...
## Preserve {background-color="#c2c190"}

A key consideration here is data _provenance_ - the history of the data, including where it came from, how it was collected, and any transformations or analyses that have been applied.
